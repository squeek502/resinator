...
- In `resinator`, embedded `NUL` (`<0x00>`) characters are always illegal anywhere in a `.rc` file.
  ...
  + This is also somewhat unavoidable as the Clang preprocessor will convert `NUL` characters outside string/char literals to space characters.
